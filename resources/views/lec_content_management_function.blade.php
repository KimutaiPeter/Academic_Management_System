    ...
    <body>
        ...
        <div class="row bg-dark">
            ...
            <div class="col d-flex flex-row-reverse">
                <button class='btn btn-success' type="button" data-toggle="modal" data-target="#exampleModalCenter">Add new content</button>
            </div>
    ...
    <script>
        ...
        function content_display(unit_content){
            ...
            unit_content.forEach(function (content){
                ...
                actions_section.innerHTML='<a><button class="btn btn-success">Open</button></a>    <a><button class="btn btn-danger">Delete</button></a>'
